              ...
              {hasError && (
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-slate-700 dark:text-slate-100">
                    服务器繁忙，请稍后再试! 或者<a href="https://github.com/aigc2d/law-cn-ai" target='_blank' className='underline underline-offset-4 decoration-slate-400/50 hover:text-indigo-500 hover:decoration-indigo-500'>自行部署</a>
                  </span>
                </div>
              )}
